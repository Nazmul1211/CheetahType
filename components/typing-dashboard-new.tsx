                ...
                <div className="mt-6">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <Button
                      ...
                      disabled={generatingText}
                      className="bg-green-50 text-slate-800  hover:bg-green-100"
                    >
                    ...
                    <Button
                      ...
                      disabled={generatingText}
                      className="bg-yellow-50 text-slate-800  hover:bg-yellow-100"
                    >
                    ...
                    <Button
                      ...
                      disabled={generatingText}
                      className="bg-red-50 text-slate-800 hover:bg-red-100"
                    >
