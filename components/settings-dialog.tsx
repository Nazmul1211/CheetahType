            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) => onUpdateSettings({ caretStyle: value as 'block' | 'underline' | 'outline' })}
                  className="flex flex-col space-y-1"
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="block" id="caret-block" />
                    <Label htmlFor="caret-block" className={darkModeLabel}>Block</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="underline" id="caret-underline" />
                    <Label htmlFor="caret-underline" className={darkModeLabel}>Underline</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="outline" id="caret-outline" />
                    <Label htmlFor="caret-outline" className={darkModeLabel}>Outline</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
